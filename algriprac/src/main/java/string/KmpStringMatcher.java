...
/**
 * created by hzhang on 9:22 AM$  6/26/2019
 * https://www.nayuki.io/res/knuth-morris-pratt-string-matching/KmpStringMatcher.java
 **/
...
public final class KmpStringMatcher {
    ...
    public static void main(String[]  args){
        KmpStringMatcher matcher = new KmpStringMatcher("absd");
        System.out.println(matcher.search("abbdfabsdfewrjljkfdsafa"));
